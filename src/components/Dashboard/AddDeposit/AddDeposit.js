                            ...
                            <form className="row gutters" onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 ">
                                    <div className="form-group pb-3">
                                        ...
                                        <input type="number" {...register("referralId", { required: true })} name="referralId" placeholder="User ID" className="form-control" />
                                        {errors.userId && <span className="text-danger">This field is required</span>}
                                    </div>
                                </div>
                                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 ">
                                    <div className="form-group pb-3">
                                        ...
                                        <input type="number" {...register("depositAmount", { required: true })} name="depositAmount" placeholder="User ID" className="form-control" />
                                        {errors.userId && <span className="text-danger">This field is required</span>}
                                    </div>
                                </div>
