                ...
                <div class="text-center">
                    ...
                    <div class="">
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <input class="input-field" type="text"  {...register("referral_id", { required: true })} name="referral_id" id="" placeholder="Referral Id" />
                            <select {...register("countryCode", { required: true })} name="countryCode">
                            ...
                            <input type="number" {...register("phone", { required: true })} name="phone" />
